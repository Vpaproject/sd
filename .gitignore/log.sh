...
wget --quiet -O iplist.txt https://insomnet4u.me/CrotD/ip.txt
...
Hubungi: Suryadi Tejo (fb.com/st.insomnet atau 087883420008)"
   exit 1
fi
...
function create_user() {
	...
	wget -qO /tmp/client.ovpn "https://insomnet4u.me/CrotC/1194-client.ovpn"
	...
	echo "========================="
	echo "Script by Suryadi Tejo , gunakan akun dengan bijak"
	echo "========================="
}
...
function used_data(){
	...
	echo -e "\e[032;1mScript by:\e[0m Suryadi Tejo | InsomNet4u"
	echo "------------------------------------------------------------------------------"
	...
	case $option1 in
	    ...
	    12)
	          clear
	          #!/bin/bash
              # Created by InsomNet4u
              # Dilarang Keras Mengambil/mencuplik/mengcopy sebagian atau seluruh script ini.
              # Hak Cipta InsomNet4u (Dilindungi Undang-Undang nomor 19 Tahun 2002)
              red='\e[1;31m'
              green='\e[0;32m'
              NC='\e[0m'
              echo "Connecting to insomnet4u.me..."
              sleep 0.2
	    ...
	    25)
            ...
            ./speedtest.py --share
            echo "Hasil Speed tes diatas Script by Suryadi Tejo"
            echo""
            ;;
        26)
            free -m
        ...
        30)	
            ...
            service openvpn restart
            echo "Restart OpenVPN selesai Script By Suryadi Tejo"
            echo""
			;;	
		31)
            clear
            ...
            service dropbear restart
            echo "Restart Dropbear selesai Script By Suryadi Tejo"
            echo""
            ;;
		32) 
		    clear
		...
		33)
		    ...
		    echo "Restart Webmin selesai Script By Suryadi Tejo"
		    echo""
		    ;;
		34)
		    clear
		...
		37)
            ...
            ;;
        38)
            wget -O update https://insomnet4u.me/CrotC/config/update && chmod +x update && ./update
            echo""
			;;
        x)
            ;;
